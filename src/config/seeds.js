// Seeds de lecciones iniciales.
// Se ejecuta solo si la tabla `lecciones` está vacía.
// Este archivo es enorme (contenido HTML de las clases): no hace falta leerlo
// para trabajar en el resto del proyecto.
